...
find_path(clang_INCLUDE_DIR clang/AST/AST.h PATHS "${llvm_SOURCE_DIR}/tools/clang/include")	
find_path(clang_BUILD_INCLUDE_DIR clang/Config/config.h PATHS "${llvm_BUILD_DIR}/tools/clang/include")	
...
if(UNIX)
    ...
    list(APPEND clang_LIBRARY_LIST Threads::Threads ${llvm_libs})
else()
    ...
    FIND_AND_ADD_CLANG_LIB(LLVMLanaiInstPrinter)
